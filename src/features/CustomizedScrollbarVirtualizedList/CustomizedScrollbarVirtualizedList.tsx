...
import styles from "./CustomizedScrollbarVirtualizedList.module.css";
...
export default function CustomizedScrollbarVirtualizedList({
 asteroids,
 setAsteroidOrders,
 distanceSelector,
 setDistanceSelector
  ...
  return (
    <>
      ...
      <div className={`${styles.asteroidsListWrapper}`}>
        ...
        <Virtuoso
          className={styles["custom-scrollbar-virtualized-list"]}
          style={{ height: 600 }}
