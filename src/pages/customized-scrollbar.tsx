...
import CustomizedScrollbarVirtualizedList
  from "@/src/features/CustomizedScrollbarVirtualizedList/CustomizedScrollbarVirtualizedList";
...
export default function VirtualizedAsteroidsListScroll({asteroids}: {asteroids: IAsteroidsList}) {
  ...
  return (
    <>
      <CustomizedScrollbarVirtualizedList
        asteroids={asteroids}
